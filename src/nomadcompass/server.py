...
logger = logging.getLogger("nomadcompass-mcp")


mcp = MCPServer(
    "NomadCompass Self-Hosted MCP",
    instructions=(
...
def export_knowledge(owner_id: str | None = None, project_id: str | None = None):
    """Read-only. Export memories/skills as a portable nomadcompass-knowledge-v1 JSON-compatible bundle."""
...
"""
    return _layout("NomadCompass MCP v9.0", body, flash=flash)
