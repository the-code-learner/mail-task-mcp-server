...
"""Pinned WhatsApp WABinary token dictionary for Postmaster v9.9.

This file contains protocol token *data* only, generated clean-room from the publicly
observable current WhatsApp Web token table snapshot used for interoperability validation.

Source snapshot: WhiskeySockets/Baileys 0af2386292907f7d9742d8d41f830d8c48208fa1
Source data file: src/WABinary/constants.ts
Single-byte tokens: 236; double-byte dictionaries: 4 x 256.

Do not treat this pin as permanent: the live GitHub Action pair-device probe is expected
to fail closed when WhatsApp changes token assignments.
"""

from .binary import TokenTable
...
CURRENT_TOKEN_TABLE = TokenTable(
    SINGLE_BYTE_TOKENS,
    DOUBLE_BYTE_TOKENS,
    version=20260921,
)

__all__ = ["SINGLE_BYTE_TOKENS", "DOUBLE_BYTE_TOKENS", "CURRENT_TOKEN_TABLE"]
